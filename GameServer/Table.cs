...
internal sealed class Table<
	...
	TGameMove>
{
	private readonly HashSet<string> _playerNames = new();
	private readonly Dictionary<int, string> _playerNamesByIds = new();
	private readonly Dictionary<int, Guid> _playerConnectionIdsByIds = new();
	private readonly Dictionary<Guid, int> _playerIdsByConnectionId = new();
	...
	public readonly struct Player : IEquatable<Player>
	{
		...
		public override int GetHashCode() =>
			(Id, Name, ConnectionId).GetHashCode();
